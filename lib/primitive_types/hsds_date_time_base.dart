...
abstract class HsdsDateTimeBase {
  const HsdsDateTimeBase(
  ...
  bool operator ==(Object o) => identical(this, o)
      ? true
      : o is! HsdsDateTimeBase
          ? o is String && isValid && HsdsDateTime(o).isValid
              ? o.length == toString().length && value == HsdsDateTime(o).value
              : false
          : isValid && o.isValid
              ? o.toString().length == toString().length && value == o.value
              : throw Exception(
                  'Two values were passed to the date time "==" comparison operator, '
                  'they were not both valid HsdsDateTimeBase types\n'
      ...
      : o is! HsdsDateTimeBase
          ? o is String && isValid && HsdsDateTime(o).isValid
              ? o.length == toString().length
                  ? value!.isAfter(HsdsDateTime(o).value!)
                  : throw ArgumentError(
                      'Two values were passed to the date time ">" comparison operator, '
  ...
  bool operator <(Object o) => identical(this, o)
      ...
      : o is! HsdsDateTimeBase
          ? o is String && isValid && HsdsDateTime(o).isValid
              ? o.length == toString().length
                  ? value!.isBefore(HsdsDateTime(o).value!)
                  : throw ArgumentError(
                      'Two values were passed to the date time "<" comparison operator, '
                      'they did not have the same precision\n'
                      'Argument 1: $value\nArgument 2: $o ')
