...
class _$_Organization extends _Organization {
  ...
  @override
  String toString() {
    return 'Organization(id: $id, name: $name, alternateName: $alternateName, description: $description, email: $email, url: $url, taxStatus: $taxStatus, taxId: $taxId, yearIncorporated: $yearIncorporated, legalStatus: $legalStatus, phone: $phone)';
  }
